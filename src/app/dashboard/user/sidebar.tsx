  ...
  return (
    <div className={`h-screen bg-white shadow-lg border-r transition-all duration-300 ${expanded ? "w-64" : "w-20"} flex flex-col`}>
      ...
      <nav className="mt-4 flex-1">
        <NavItem href="/dashboard/user" icon={FaHome} label="Dashboard" expanded={expanded} />
        <NavItem href="/dashboard/user/search" icon={FaSearch} label="Search for Spaces" expanded={expanded} />
        <NavItem href="/dashboard/user/saved-spaces" icon={FaBookmark} label="Saved Spaces" expanded={expanded} />
        <NavItem href="/dashboard/user/messages" icon={FaEnvelope} label="Messages" expanded={expanded} />
        <NavItem href="/dashboard/user/payments" icon={FaMoneyBillWave} label="Payments" expanded={expanded} />
        <NavItem href="/dashboard/user/settings" icon={FaCog} label="Settings" expanded={expanded} />
      </nav>
