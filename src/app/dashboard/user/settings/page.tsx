    ...
    <div className="bg-white p-6 shadow-md rounded-lg">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/user/settings/profile" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
          ...
          <Link href="/dashboard/user/settings/security" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/user/settings/preferences" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/user/settings/payments" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/user/settings/property" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/user/settings/integrations" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/user/settings/delete-account" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
