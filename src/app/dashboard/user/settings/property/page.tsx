...
const PropertySettings = () => {
  ...
  return (
    <div className="bg-white p-6 shadow-md rounded-lg max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-800 mb-4">🏡 Space Settings</h1>
      <p className="text-gray-600 mb-6">Manage space settings and default configurations.</p>

      <div className="flex items-center justify-between bg-gray-100 p-4 rounded-lg shadow-sm mb-4">
        <span className="text-gray-800">Allow space listings</span>
        <input
          type="checkbox"
          name="allowListings"
      ...
      {/* Featured Spaces */}
      <div className="flex items-center justify-between bg-gray-100 p-4 rounded-lg shadow-sm mb-4">
        <span className="text-gray-800">Mark spaces as featured</span>
        <input
          type="checkbox"
