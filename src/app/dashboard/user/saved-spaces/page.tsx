    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Saved Spaces</h1>
            <p className="text-gray-600">Browse and manage your saved spaces.</p>
          </div>
          {/* Explore More CTA */}
          <button
        ...
        {savedHouses.length > 0 ? (
          ...
          <div className="text-center py-10 bg-white shadow-lg rounded-lg">
            <p className="text-gray-600 text-lg">You haven’t saved any spaces yet.</p>
            <p className="text-gray-500">Browse listings and click the ❤️ to save spaces.</p>
            <button
              onClick={() => router.push("/search")}
