  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        ...
        >
          <Plus size={18} className="mr-2" /> Add Space
        </Link>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProperties.map((property) => (
            <div key={property.id} className="bg-white p-4 shadow-md rounded-lg hover:shadow-lg transition">
              ...
              <p
                className={`text-sm font-bold mt-1 px-2 py-1 rounded ${property.status === "Available"
              ...
              <div className="flex justify-between mt-4">
                <Link
                  href={`/dashboard/agent/properties/edit?id=${property.id}`}
