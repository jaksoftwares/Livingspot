  ...
  return (
    <div className={`h-screen bg-white shadow-lg border-r transition-all duration-300 ${expanded ? "w-64" : "w-20"}`}>
      ...
      <nav className="mt-6 space-y-2">
        <SidebarLink href="/dashboard/agent" icon={<FaHome />} text="Dashboard" expanded={expanded} />
        <SidebarLink href="/dashboard/agent/properties" icon={<FaBuilding />} text="Spaces" expanded={expanded} />
        <SidebarLink href="/dashboard/agent/messages" icon={<FaEnvelope />} text="Messages" expanded={expanded} />
        <SidebarLink href="/dashboard/agent/reviews" icon={<FaStar />} text="Reviews" expanded={expanded} />
        <SidebarLink href="/dashboard/agent/reports" icon={<FaFileAlt />} text="Reports" expanded={expanded} />
        <SidebarLink href="/dashboard/agent/settings" icon={<FaCog />} text="Settings" expanded={expanded} />
