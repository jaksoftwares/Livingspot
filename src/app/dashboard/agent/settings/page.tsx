    ...
    <div className="bg-white p-6 shadow-md rounded-lg">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/agent/settings/profile" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
          ...
          <Link href="/dashboard/agent/settings/security" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/agent/settings/preferences" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/agent/settings/payments" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        <h2 className="text-lg font-semibold text-gray-700 mb-2">🏠 Space Settings</h2>
        <div className="space-y-3">
          <Link href="/dashboard/agent/settings/property" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
            <FiHome className="mr-3 text-purple-600" size={20} />
            <div>
              <p className="font-semibold">Space Visibility</p>
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/agent/settings/integrations" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          <Link href="/dashboard/agent/settings/delete-account" className="flex items-center bg-gray-100 p-4 rounded-lg shadow hover:bg-gray-200 transition">
