  ...
  return (
    <div className="bg-white p-6 shadow-md rounded-lg">
      ...
      <div className="mt-6 space-y-4">
        <Link href="/dashboard/agent/support/faqs" className="block p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
        ...
        <Link href="/dashboard/agent/support/contact" className="block p-4 bg-gray-100 rounded-lg shadow hover:bg-gray-200 transition">
