...
const faqs = [
  ...
  { question: "How do I contact a user?", answer: "Use the Messages section to chat with users in real time." },
  { question: "What do I do if a user is not responding?", answer: "Try sending them a message reminder or updating your property status." },
];
...
const FAQsPage = () => {
  ...
  return (
    <div className="bg-white p-6 shadow-md rounded-lg">
      ...
      <p className="text-gray-600 mt-2">Find answers to common questions agents have.</p>
